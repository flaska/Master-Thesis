...
GDCM\cite{gdcm_home} is a tool, which allows conversion of DICOM files' header. The conversion performed on an un-readable image, repaired the file header that way, that the image could be fully usable in Dicom-Presenter. The question was how to import the external tool into Dicom-Presenter. Three posibilities became apparent:
