...
The algorithm performs expanding a closed curve inside the segmented area. The idea of the algorithm is, that the time evolution of the curve can be described by a two-dimensional real function $\varphi:RxR->R$
...
\red{jaky je vstup u kuby, jaky je vstup u radka} \\
\red{jaky je vystup u obou}
